...
esp_websocket_client_handle_t websocket_start()
{
    ...
    esp_websocket_client_send_text(websocket_client_handle, data, sizeof(data), portMAX_DELAY);
    memset(data, 'b', sizeof(data));
    esp_websocket_client_send_bin(websocket_client_handle, data, sizeof(data), portMAX_DELAY);
